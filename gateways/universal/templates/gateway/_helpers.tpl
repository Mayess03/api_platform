...
Common labels
*/}}
{{- define "apim-helm-gw.labels" -}}
app.kubernetes.io/name: {{ include "apim-helm-gw.name" . }}
helm.sh/chart: {{ include "apim-helm-gw.chart" . }}
