...
Common labels
*/}}
{{- define "apim-helm-tm.labels" -}}
app.kubernetes.io/name: {{ include "apim-helm-tm.name" . }}
helm.sh/chart: {{ include "apim-helm-tm.chart" . }}
